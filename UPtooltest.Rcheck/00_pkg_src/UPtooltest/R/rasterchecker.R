#' This function read and resample the rasters and convert all the raster data into a stack
#'
...
#' @return A standardize raster, or rasters with the same extent and resolution, and projection
#' @import raster
#' @export
#' @examples
#' library(raster)
