...
#'
#' METHOD:
#' The first step is to identify the each land cover category (i) included in the raster.
#' Then, the total area for each category is calculated by adding up the square kilometers (areai)
#' of each land cover.
#'
#' @param ras a raster that contains different land covers
#' @param class base parameter is NULL, user can load a data frame that contains land cover classification
#' @return a data frame with information about the land consumption in square kilometers
#' @import raster
#' @export
#' @examples
#' library(raster)
